    ...
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center pt-10 overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-6">
          ...
          >
            Assistly - PWD Volunteer Network
          </motion.h1>
          <motion.p 
      ...
      <section id="who-are-you" className="py-24 px-6 relative z-20 -mt-12 md:-mt-32">
        <div className="max-w-6xl mx-auto">
          <div className="bg-card dark:bg-card rounded-[2.5rem] shadow-2xl p-8 md:p-16 border border-border/50">
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <motion.div 
                whileHover={{ y: -5 }}
                className="bg-muted dark:bg-card rounded-3xl overflow-hidden px-6 py-2 md:p-8 flex flex-col md:flex-row gap-8 items-center border border-border transition-all"
              >
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <h3 className="text-3xl font-black text-foreground mb-4">Student</h3>
                  ...
                  <Button asChild audioLabel="Login as student" 
                    className="w-full md:w-auto bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl px-8 py-6 font-bold flex items-center justify-center gap-2"
              ...
              >
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <h3 className="text-3xl font-black text-foreground mb-4">Volunteer</h3>
                  <p className="text-muted-foreground text-sm md:text-base leading-relaxed mb-6">
      ...
      <section id="how-it-works" className="pb-10 px-6 bg-muted/30 dark:bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                className="bg-card dark:bg-card p-10 rounded-3xl border border-border shadow-soft hover:shadow-lg transition-all text-center md:text-left"
                aria-label={feature.title + ": " + feature.desc}
                onMouseEnter={() => speak(feature.speak)}
              >
                <div className="w-14 h-14 bg-muted dark:bg-muted rounded-2xl flex items-center justify-center mb-6 shadow-sm mx-auto md:mx-0">
                  {feature.icon}
                </div>
      ...
      {/* Modern Footer */}
      <footer className="bg-card text-card-foreground py-6 px-6 border-t border-border">
        <div className="max-w-full mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-4 border-b border-border/50 pb-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-black tracking-tighter">Assistly</span>
            </div>
            <nav className="flex flex-wrap justify-center gap-8 text-sm font-bold text-muted-foreground">
              ...
              <Link href="/dev" className="text-muted-foreground/60 hover:text-muted-foreground transition-colors">Developer Portal</Link>
            </nav>
            <div className="text-muted-foreground text-sm font-bold">
              © 2026 Assistly. All rights reserved.
            </div>
          </div>
        </div>
      </footer>
